# (q-1)-nest Construction - Companion Derived
...
bakerEbertQMinusOneNestCompanionDerivedImplementation(q,b);
...
If successful, a Magma PlaneProj object modeling a (q-1)-nest plane of order q^2 which has been derived using one of the reguli from the companion nest, as all such reguli are definitionally in the same orbit under an automorphism group that fixes the original nest, the planes obtained from reversing any of the corresponding reguli will be isomorphic.
