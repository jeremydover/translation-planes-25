...
See also:
Kantor, W.M., Ovoids and translation planes. Canad. J. Math. 34:1195-1207,1982.
...
=
Type: Integer
Description: Order of ground field for J1-fibration construction; q must be an odd prime power equivalent to 0 or 2 mod 3.
...
j1HyperbolicFibrationImplementation(q,reguli);
...
If successful, a Magma PlaneProj object modeling a plane spawned from the J1-fibration as described in Baker et al.
