# Pabst-Sherk/Ebert (q+1)-nest/H-Fibrations

## Reference
Pabst-Sherk
===========
Pabst, G. and Sherk, F.A., Indicator sets, reguli and a new class of spreads. Canad. J. Math. 29:132–154, 1977.
...
=
Type: Integer
Description: Order of ground field for H-fibration construction; q must be an odd prime power.
...
hHyperbolicFibrationImplementation(q,reguli);
...
If successful, a Magma PlaneProj object modeling a plane spawned from the H-fibration which gives rise to the Pabst-Sherk/(q+1)-nest family of projective planes.

### Notes
There are several different presentations of these planes; computationally we prefer the presentation as a hyperbolic fibration, as it allows us to utilize the general machinery for hyperbolic fibrations to create any spread spawned from the hyperbolic fibration, without reference to any predecessor construction.